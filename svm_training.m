...
%------------------Angry----------------------------------------
rng(10);
Features=[File.features(1:12,:);File.features(13:24,:)];
...
rng(10);
Features=[File.features(1:12,:);File.features(25:36,:)];
...
rng(10);
Features=[File.features(1:12,:);File.features(37:46,:)];
...
%-----------------Happy-----------------------------------------
rng(10);
Features=[File.features(13:24,:);File.features(1:12,:)];
...
rng(10);
Features=[File.features(13:24,:);File.features(25:36,:)];
...
rng(10);
Features=[File.features(13:24,:);File.features(37:46,:)];
...
%-----------------Neutral---------------------------------------
rng(10);
Features=[File.features(25:36,:);File.features(13:24,:)];
...
rng(10);
Features=[File.features(25:36,:);File.features(1:12,:)];
...
rng(10);
Features=[File.features(25:36,:);File.features(37:46,:)];
...
%-----------------Sad--------------------------------------
rng(10);
Features=[File.features(37:46,:);File.features(1:12,:)];
...
rng(10);
Features=[File.features(37:46,:);File.features(25:36,:)];
...
rng(10);
Features=[File.features(37:46,:);File.features(13:24,:)];
