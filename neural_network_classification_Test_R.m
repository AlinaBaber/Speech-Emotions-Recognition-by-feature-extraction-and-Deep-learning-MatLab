function [Category,Category_cost,Category_output,Emotion,Emotion_cost,Emotions_output]=neural_network_classification_Test_R(Features)
%Features= allfeatures_extraction( wav_file );
MFile= load('nnmodel'); File= load('test_speech');
